...
namespace Lab5
{
    public class Wagner
    {
        public int findDistance(string str1, string str2)
        {
            ...
            if ((str1 == null) || (str2 == null)) return -1; //случай, когда одно из слов не введено
            if ((str1Len == 0) && (str2Len == 0)) return 0; //случай, когда строки нулевые
            if (str1Len == 0) return str2Len; // -//- только одна строка нулевая
            ...
            return matr[str1Len, str2Len]; //итоговое расстрояние
        }
    }
}
